HarmanSignalProcessingWebsite::Application.configure do
  ...
  config.assets.precompile += %w( istomp.js istomp_coverflow.js istomp.css admin.js admin.css dbx.css digitech.css hardwire.css jbl_commercial.css lexicon.css pdx.css site.css vocalist.css )
