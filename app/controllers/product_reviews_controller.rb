class ProductReviewsController < ApplicationController
  ...
  def show
    ...
    if !@product_review.external_link.blank?
      redirect_to @product_review.external_link, status: :moved_permanently and return false
    elsif !@product_review.review_file_name.blank?
      redirect_to @product_review.review.url, status: :moved_permanently and return false
    end
    respond_to do |format|
