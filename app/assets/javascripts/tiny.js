...
tinyMCE.init({
  ...
  language: 'en',
  mode: 'textareas',
  plugins: "advlist,anchor,autolink,autoresize,code,colorpicker,hr,image,link,lists,media,searchreplace,spellchecker,textcolor,table,paste,preview",
  relative_urls: false,
});
tinyMCE.init({
  ...
  language: 'en',
  mode: 'textareas',
  plugins: "advlist,anchor,autolink,autoresize,code,colorpicker,hr,image,link,lists,media,searchreplace,spellchecker,textcolor,table,paste,preview,fullpage,fullscreen",
  relative_urls: false,
});
