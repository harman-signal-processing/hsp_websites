...
Gem::Specification.new do |s|
  ...
  s.files = [".codeclimate.yml".freeze, ".github/workflows/ci.yml".freeze, ".gitignore".freeze, ".rubocop.yml".freeze, "CHANGELOG.md".freeze, "Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "actionpack-action_caching.gemspec".freeze, "gemfiles/Gemfile-4-2-stable".freeze, "gemfiles/Gemfile-5-0-stable".freeze, "gemfiles/Gemfile-5-1-stable".freeze, "gemfiles/Gemfile-5-2-stable".freeze, "gemfiles/Gemfile-6-0-stable".freeze, "gemfiles/Gemfile-6-1-stable".freeze, "gemfiles/Gemfile-edge".freeze, "lib/action_controller/action_caching.rb".freeze, "lib/action_controller/caching/actions.rb".freeze, "lib/actionpack/action_caching.rb".freeze, "lib/actionpack/action_caching/railtie.rb".freeze, "test/abstract_unit.rb".freeze, "test/caching_test.rb".freeze, "test/fixtures/layouts/talk_from_action.html.erb".freeze]
