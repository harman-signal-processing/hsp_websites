...
RSpec.describe "toolkit/products/show.html.erb", as: :view do
  ...
  context "Current product" do
    before do
      @product = FactoryBot.create(:product, brand: @brand, description: "Foo bar's are delicious")
  ...
  context "discontinued product pages" do
    before do
      ...
      @discontinued_product = FactoryBot.create(:product, brand: @brand, product_status: discontinued, description: "Iz no good no mo.")
  ...
  context "announced product pages" do
    before do
      ...
      @product = FactoryBot.create(:product, brand: @brand, product_status: announced, description: "Here it comes..")
      assign(:product, @product)
