...
feature "Distributor signs up for Toolkit" do
  ...
  scenario "should send the confirmation email to the distributor not the user" do
    user = FactoryGirl.build(:user, email: "someone@distributor.com")
  ...
  scenario "should send an email error to user where no distributor is found" do
    user = FactoryGirl.build(:user, email: "someone@distributor.com")
