...
#
if defined? Geokit
  require 'geokit-rails/defaults.rb'
  require 'geokit-rails/adapters/abstract.rb'
  require 'geokit-rails/acts_as_mappable.rb'
  require 'geokit-rails/ip_geocode_lookup.rb'
