...
# Old recipe to configure and restart nginx, not used anymore
...
namespace :nginx do
  ...
  task :configure, roles: :web do
    %w[a_catchall archimedia bss crown dbx digitech dod hardwire idx jbl_commercial lexicon testsites vocalist toolkits].each do |site_name|
