...
namespace :amx_nav do
  ...
  task :update_nav => :environment do
    ...
    # BEGIN TASK METHOD DEFINITIONS
        ...
        def new_product_families_to_create
          ...
          [
            ...
            # nil | Networked AV | SVSI Windowing Processors | 1G AVoIP Window Processing
            { name: "1G AVoIP Window Processing", parent: "SVSI Windowing Processors", grand_parent: "Networked AV", position: 1},
            # nil | Networked AV | SVSI Windowing Processors | 1G AVoIP Window Processing | N2400 Series (4K60 4x1)
            { name: "N2400 Series (4K60 4x1)", parent: "1G AVoIP Window Processing", parent_slug: "1g-avoip-window-processing", grand_parent: "SVSI Windowing Processors", grand_parent_slug: "svsi-windowing-processors", position: 1},
            # nil | Networked AV | SVSI Windowing Processors | 1G AVoIP Window Processing | N2000 Series (HD 4x1)
            { name: "N2000 Series (HD 4x1)", parent: "1G AVoIP Window Processing", parent_slug: "1g-avoip-window-processing", grand_parent: "SVSI Windowing Processors", grand_parent_slug: "svsi-windowing-processors", position: 2},
            # nil | Networked AV | SVSI Windowing Processors | 1G AVoIP Window Processing | N1000 Series (HD 4x1)
            { name: "N1000 Series (HD 4x1)", parent: "1G AVoIP Window Processing", parent_slug: "1g-avoip-window-processing", grand_parent: "SVSI Windowing Processors", grand_parent_slug: "svsi-windowing-processors", position: 3},
            ...
            # nil | Traditional A/V Distribution | Fixed Switchers | VPX Series Presentation Switchers | VPX (4K60 4x1 +1)
            { name: "VPX (4K60 4x1 +1)", parent: "VPX Series Presentation Switchers", parent_slug:"vpx-series-presentation-switchers", grand_parent: "Fixed Switchers", grand_parent_slug:"fixed-switchers", position: 1},
            # nil | Traditional A/V Distribution | Fixed Switchers | VPX Series Presentation Switchers | VPX (4K60 7x1 +1)
            { name: "VPX (4K60 7x1 +1)", parent: "VPX Series Presentation Switchers", parent_slug:"vpx-series-presentation-switchers", grand_parent: "Fixed Switchers", grand_parent_slug:"fixed-switchers", position: 2},
            # nil | Traditional A/V Distribution | Fixed Switchers | Solecis Digital Switchers | SDX (4K30 4x1 +1)
            { name: "SDX (4K30 4x1 +1)", parent: "Solecis Digital Switchers", grand_parent: "Fixed Switchers", position: 1},
            # nil | Traditional A/V Distribution | Fixed Switchers | Solecis Digital Switchers | SDX (4K30 5x1 +1)
            { name: "SDX (4K30 5x1 +1)", parent: "Solecis Digital Switchers", grand_parent: "Fixed Switchers", position: 2},
            ...
            { name: "N2400 Series (4K60 4x1)", parent: "1G Solutions", parent_slug: "amx-1g-solutions", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 1},
            # nil | Video Signal Processing | Window Processing | 1G Solutions | N2000 Series (4K30 4x1)
            { name: "N2000 Series (4K30 4x1)", parent: "1G Solutions", parent_slug: "amx-1g-solutions", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 2},
            # nil | Video Signal Processing | Window Processing | 1G Solutions | N1000 Series (HD 4x1)
            { name: "N1000 Series (HD 4x1)", parent: "1G Solutions", parent_slug: "amx-1g-solutions", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 3},
            ...
            { name: "N3000 Series (HD 9x1)", parent: "H.264 Solutions", parent_slug: "amx-h-264-solutions-1214", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 1},
            ...
            # Control Processing | Controllers w/ Switching | DVX 4K60
            { name: "DVX 4K60", parent: "Controllers w/ Switching", parent_slug: "controllers-w-switching", grand_parent: "Control Processing", grand_parent_slug: "control-processing", position: 2},
            # Control Processing | Controllers w/ Switching | DVX HD
            { name: "DVX HD", parent: "Controllers w/ Switching", parent_slug: "controllers-w-switching", grand_parent: "Control Processing", grand_parent_slug: "control-processing", position: 3},
            ...
            # nil | Traditional A/V Distribution | Modular Switching Systems | Audio Cards | Audio Switching Board Kits
            { name: "Audio Switching Board Kits", parent: "Audio Cards", parent_slug: "audio-cards", grand_parent: "Modular Switching Systems", grand_parent_slug: "modular-switching-systems", position: 1},
            # nil | Traditional A/V Distribution | Modular Switching Systems | Audio Cards | Audio Insert/Extract Board
            { name: "Audio Insert/Extract Board", parent: "Audio Cards", parent_slug: "audio-cards", grand_parent: "Modular Switching Systems", grand_parent_slug: "modular-switching-systems", position: 2},
            # nil | Traditional A/V Distribution | Traditional A/V Accessories | Cables
            { name: "Cables", parent: "Traditional A/V Accessories", parent_slug: "traditional-a-v-accessories", grand_parent: "Traditional A/V Distribution", grand_parent_slug: "traditional-a-v-distribution", position: 3}
          ]
        ...
        def product_families_to_rename
          [
            ...
            { old: "SVSI N2000 Series JPEG2000 /LAN", new: "N2000 Series (HD)", parent: "1G Solutions", grand_parent: "Encoding & Decoding", position: 3},
        ...
        def product_product_families_to_change
          ...
          [
            ...
            { product_name: "VPX-1401",                           product_slug: "vpx-1401",                         remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "VPX (4K60 4x1 +1)",                                  new_product_family_slug: "vpx-4k60-4x1-1",            grand_parent_product_family: "VPX Series Presentation Switchers",   grand_parent_product_family_slug: "vpx-series-presentation-switchers"},
            { product_name: "VPX-1701",                           product_slug: "vpx-1701",                         remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "VPX (4K60 7x1 +1)",                                  new_product_family_slug: "vpx-4k60-7x1-1",            grand_parent_product_family: "VPX Series Presentation Switchers",   grand_parent_product_family_slug: "vpx-series-presentation-switchers"},
            { product_name: "SDX-414-DX",                         product_slug: "sdx-414-dx",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "SDX (4K30 4x1 +1)",                                  new_product_family_slug: "sdx-4k30-4x1-1",            grand_parent_product_family: "Solecis Digital Switchers",           grand_parent_product_family_slug: "solecis-digital-switchers"},
            { product_name: "SDX-514M-DX",                        product_slug: "sdx-514m-dx",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "SDX (4K30 5x1 +1)",                                  new_product_family_slug: "sdx-4k30-5x1-1",            grand_parent_product_family: "Solecis Digital Switchers",           grand_parent_product_family_slug: "solecis-digital-switchers"},
            ...
            # remove these products from 4k60-cards-and-endpoints
            { product_name: "NMX-DEC-N2422A Decoder",             product_slug: "nmx-dec-n2422a-decoder",           remove_from_product_family: "4K60 Cards and Endpoints",           remove_from_product_family_slug: "4k60-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-DEC-N2424A Decoder",             product_slug: "nmx-dec-n2424a-decoder",           remove_from_product_family: "4K60 Cards and Endpoints",           remove_from_product_family_slug: "4k60-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-ENC-N2412A Encoder",             product_slug: "nmx-enc-n2412a-encoder",           remove_from_product_family: "4K60 Cards and Endpoints",           remove_from_product_family_slug: "4k60-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-ENC-N2412A-C Encoder Card",      product_slug: "nmx-enc-n2412a-c-encoder-card",    remove_from_product_family: "4K60 Cards and Endpoints",           remove_from_product_family_slug: "4k60-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-WP-N2410 Windowing Processor",   product_slug: "nmx-wp-n2410-windowing-processor", remove_from_product_family: "4K60 Cards and Endpoints",           remove_from_product_family_slug: "4k60-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},


            { product_name: "DXFP-TX-4K60",                       product_slug: "dxfp-tx-4k60",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXFP-RX-4K60",                       product_slug: "dxfp-rx-4k60",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-TX-MMD",                         product_slug: "dxf-tx-mmd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-RX-MMD",                         product_slug: "dxf-rx-mmd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-TX-MMS",                         product_slug: "dxf-tx-mms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-RX-MMS",                         product_slug: "dxf-rx-mms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-TX-SMD",                         product_slug: "dxf-tx-smd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-RX-SMD",                         product_slug: "dxf-rx-smd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-TX-SMS",                         product_slug: "dxf-tx-sms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DXF-RX-SMS",                         product_slug: "dxf-rx-sms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink Fiber (>100m)",                               new_product_family_slug: "dxlink-fiber-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},

            { product_name: "DX-TX-4K60",                         product_slug: "dx-tx-4k60",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DX-RX-4K60",                         product_slug: "dx-rx-4k60",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DX-TX-DWP-4K",                       product_slug: "dx-tx-dwp-4k",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DX-RX-4K",                           product_slug: "dx-rx-4k",                         remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DX-TX",                              product_slug: "dx-tx",                            remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DX-RX",                              product_slug: "dx-rx",                            remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DX-TX-DWP",                          product_slug: "dx-tx-dwp",                        remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            { product_name: "DX-TX-WP",                           product_slug: "dx-tx-wp",                         remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLink U/STP (<100m)",                               new_product_family_slug: "dxlink-u-stp-100m",         grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},


            { product_name: "DXL-TX-4K60",                        product_slug: "dxl-tx-4k60",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DXLite U/STP (<70m)",                                new_product_family_slug: "dxlite-u-stp-70m",          grand_parent_product_family: "A/V Distance Transport Solutions",    grand_parent_product_family_slug: "a-v-distance-transport-solutions"},
            ...
            { product_name: "DGX-I-HDMI-4K",                      product_slug: "dgx-i-hdmi-4k",                    remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "4K30 Cards and Endpoints",                           new_product_family_slug: "4k30-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "Placeholder",                        product_slug: "placeholder",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "4K30 Cards and Endpoints",                           new_product_family_slug: "4k30-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DGX-I-DXL-4K",                       product_slug: "dgx-i-dxl-4k",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "4K30 Cards and Endpoints",                           new_product_family_slug: "4k30-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DGX-0-DXL-4K",                       product_slug: "dgx-o-dxl-4k",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "4K30 Cards and Endpoints",                           new_product_family_slug: "4k30-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DX-TX-DWP-4K",                       product_slug: "dx-tx-dwp-4k",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "4K30 Cards and Endpoints",                           new_product_family_slug: "4k30-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DX-RX-4K",                           product_slug: "dx-rx-4k",                         remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "4K30 Cards and Endpoints",                           new_product_family_slug: "4k30-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},

            # remove these products from 4k30-cards-and-endpoints
            { product_name: "NMX-DEC-N2322 Decoder",              product_slug: "nmx-dec-n2322-decoder",            remove_from_product_family: "4K30 Cards and Endpoints",           remove_from_product_family_slug: "4k30-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-ENC-N2312 Encoder",              product_slug: "nmx-enc-n2312-encoder",            remove_from_product_family: "4K30 Cards and Endpoints",           remove_from_product_family_slug: "4k30-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-ENC-N2312-C Encoder Card",       product_slug: "nmx-enc-n2312-c-encoder-card",     remove_from_product_family: "4K30 Cards and Endpoints",           remove_from_product_family_slug: "4k30-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-ENC-N2315-WP Wallplate Encoder", product_slug: "nmx-enc-n2315-wp-wallplate-encoder", remove_from_product_family: "4K30 Cards and Endpoints",         remove_from_product_family_slug: "4k30-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-ENC-N2412A Encoder",             product_slug: "nmx-enc-n2412a-encoder",           remove_from_product_family: "4K30 Cards and Endpoints",           remove_from_product_family_slug: "4k30-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "NMX-ENC-N2412A-C Encoder Card",      product_slug: "nmx-enc-n2412a-c-encoder-card",    remove_from_product_family: "4K30 Cards and Endpoints",           remove_from_product_family_slug: "4k30-cards-and-endpoints",          new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},


            { product_name: "DGX-I-HDMI",                         product_slug: "dgx-i-hdmi",                        remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DGX-O-HDMI",                         product_slug: "dgx-o-hdmi",                        remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            ...
            { product_name: "DX-TX",                              product_slug: "dx-tx",                            remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DX-RX",                              product_slug: "dx-rx",                            remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DX-TX-DWP",                          product_slug: "dx-tx-dwp",                        remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "Placeholder",                        product_slug: "placeholder",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DX-TX-WP",                           product_slug: "dx-tx-wp",                         remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "Placeholder2",                       product_slug: "placeholder2",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-TX-MMD",                         product_slug: "dxf-tx-mmd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-RX-MMD",                         product_slug: "dxf-rx-mmd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-TX-SMD",                         product_slug: "dxf-tx-smd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-RX-SMD",                         product_slug: "dxf-rx-smd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-TX-MMS",                         product_slug: "dxf-tx-mms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-RX-MMS",                         product_slug: "dxf-rx-mms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-TX-SMS",                         product_slug: "dxf-tx-sms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            { product_name: "DXF-RX-SMS",                         product_slug: "dxf-rx-sms",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HD Cards and Endpoints",                             new_product_family_slug: "hd-cards-and-endpoints",    grand_parent_product_family: "Modular Switching Systems",           grand_parent_product_family_slug: "modular-switching-systems"},
            ...
            { product_name: "DGX-AIE",                            product_slug: "dgx-aie",                          remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Audio Insert/Extract Board",                         new_product_family_slug: "audio-insert-extract-board",grand_parent_product_family: "Audio Cards",                         grand_parent_product_family_slug: "audio-cards"},
            { product_name: "DGX3200-ASB-DAN",                    product_slug: "dgx3200-asb-dan",                  remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Audio Switching Board Kits",                         new_product_family_slug: "audio-switching-board-kits",grand_parent_product_family: "Audio Cards",                         grand_parent_product_family_slug: "audio-cards"},
            { product_name: "DGX6400-ASB-DAN",                    product_slug: "dgx6400-asb-dan",                  remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Audio Switching Board Kits",                         new_product_family_slug: "audio-switching-board-kits",grand_parent_product_family: "Audio Cards",                         grand_parent_product_family_slug: "audio-cards"},
            { product_name: "DGX800/1600-ASB",                    product_slug: "dgx800-1600-asb",                  remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Audio Switching Board Kits",                         new_product_family_slug: "audio-switching-board-kits",grand_parent_product_family: "Audio Cards",                         grand_parent_product_family_slug: "audio-cards"},
            { product_name: "DGX3200-ASB",                        product_slug: "dgx3200-asb",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Audio Switching Board Kits",                         new_product_family_slug: "audio-switching-board-kits",grand_parent_product_family: "Audio Cards",                         grand_parent_product_family_slug: "audio-cards"},
            { product_name: "DGX6400-ASB",                        product_slug: "dgx6400-asb",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Audio Switching Board Kits",                         new_product_family_slug: "audio-switching-board-kits",grand_parent_product_family: "Audio Cards",                         grand_parent_product_family_slug: "audio-cards"},
            { product_name: "DGX-I-DXFP-4K60",                    product_slug: "dgx-i-dxfp-4k60",                  remove_from_product_family: "DXLink Fiber (>100m)",               remove_from_product_family_slug: "dxlink-fiber-100m",                 new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            { product_name: "DGX-O-DXFP-4K60",                    product_slug: "dgx-o-dxfp-4k60",                  remove_from_product_family: "DXLink Fiber (>100m)",               remove_from_product_family_slug: "dxlink-fiber-100m",                 new_product_family: "",                                                   new_product_family_slug: "",                          grand_parent_product_family: "",                                    grand_parent_product_family_slug: ""},
            ...
            { product_name: "DVX-2265-4K",                        product_slug: "dvx-2265-4k",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DVX 4K60",                                           new_product_family_slug: "dvx-4k60",                  grand_parent_product_family: "Controllers w/ Switching",            grand_parent_product_family_slug: "controllers-w-switching"},
            { product_name: "DVX-3266-4K",                        product_slug: "dvx-3266-4k",                      remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DVX 4K60",                                           new_product_family_slug: "dvx-4k60",                  grand_parent_product_family: "Controllers w/ Switching",            grand_parent_product_family_slug: "controllers-w-switching"},
            { product_name: "DVX-2210HD",                         product_slug: "dvx-2210hd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DVX HD",                                             new_product_family_slug: "dvx-hd",                    grand_parent_product_family: "Controllers w/ Switching",            grand_parent_product_family_slug: "controllers-w-switching"},
            { product_name: "DVX-2250HD",                         product_slug: "dvx-2250hd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DVX HD",                                             new_product_family_slug: "dvx-hd",                    grand_parent_product_family: "Controllers w/ Switching",            grand_parent_product_family_slug: "controllers-w-switching"},
            { product_name: "DVX-2255HD",                         product_slug: "dvx-2255hd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DVX HD",                                             new_product_family_slug: "dvx-hd",                    grand_parent_product_family: "Controllers w/ Switching",            grand_parent_product_family_slug: "controllers-w-switching"},
            { product_name: "DVX-3255HD",                         product_slug: "dvx-3255hd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DVX HD",                                             new_product_family_slug: "dvx-hd",                    grand_parent_product_family: "Controllers w/ Switching",            grand_parent_product_family_slug: "controllers-w-switching"},
            { product_name: "DVX-3256HD",                         product_slug: "dvx-3256hd",                       remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "DVX HD",                                             new_product_family_slug: "dvx-hd",                    grand_parent_product_family: "Controllers w/ Switching",            grand_parent_product_family_slug: "controllers-w-switching"},

            { product_name: "CC-3.5ST5-RCA2F",                    product_slug: "cc-3-5st5-rca2f",                  remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Cables",                                             new_product_family_slug: "amx-cables",                grand_parent_product_family: "Traditional A/V Accessories",         grand_parent_product_family_slug: "traditional-a-v-accessories"},
            { product_name: "CC-DVI-5BNCM",                       product_slug: "cc-dvi-5bncm",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Cables",                                             new_product_family_slug: "amx-cables",                grand_parent_product_family: "Traditional A/V Accessories",         grand_parent_product_family_slug: "traditional-a-v-accessories"},
            { product_name: "CC-DVI-RCA3M",                       product_slug: "cc-dvi-rca3m",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Cables",                                             new_product_family_slug: "amx-cables",                grand_parent_product_family: "Traditional A/V Accessories",         grand_parent_product_family_slug: "traditional-a-v-accessories"},
            { product_name: "CC-DVIM-VGAF",                       product_slug: "cc-dvim-vgaf",                     remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "Cables",                                             new_product_family_slug: "amx-cables",                grand_parent_product_family: "Traditional A/V Accessories",         grand_parent_product_family_slug: "traditional-a-v-accessories"},

            { product_name: "HPG-10",                             product_slug: "hpg-10",                           remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HydraPort Enclosures & Grommets",                    new_product_family_slug: "hydraport-enclosures-grommets", grand_parent_product_family: "Architectural Connectivity",      grand_parent_product_family_slug: "architectural-connectivity"},
            { product_name: "HPG-20",                             product_slug: "hpg-20",                           remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "HydraPort Enclosures & Grommets",                    new_product_family_slug: "hydraport-enclosures-grommets", grand_parent_product_family: "Architectural Connectivity",      grand_parent_product_family_slug: "architectural-connectivity"},

            { product_name: "NMX-WP-N2410 Windowing Processor",   product_slug: "nmx-wp-n2410-windowing-processor", remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "1G AVoIP Window Processing",                         new_product_family_slug: "1g-avoip-window-processing", grand_parent_product_family: "Window Processing",                   grand_parent_product_family_slug: "amx-window-processing-380"},
            { product_name: "NMX-WP-N2510 Windowing Processor",   product_slug: "nmx-wp-n2510-windowing-processor", remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "1G AVoIP Window Processing",                         new_product_family_slug: "1g-avoip-window-processing", grand_parent_product_family: "Window Processing",                   grand_parent_product_family_slug: "amx-window-processing-380"},
            { product_name: "NMX-WP-N1512 Windowing Processor",   product_slug: "nmx-wp-n1512-windowing-processor", remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "1G AVoIP Window Processing",                         new_product_family_slug: "1g-avoip-window-processing", grand_parent_product_family: "Window Processing",                   grand_parent_product_family_slug: "amx-window-processing-380"},

            { product_name: "NMX-WP-N2410 Windowing Processor",   product_slug: "nmx-wp-n2410-windowing-processor", remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "1G Solutions",                                       new_product_family_slug: "amx-1g-solutions",          grand_parent_product_family: "Window Processing",                   grand_parent_product_family_slug: "amx-window-processing"},
            { product_name: "NMX-WP-N2510 Windowing Processor",   product_slug: "nmx-wp-n2510-windowing-processor", remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "1G Solutions",                                       new_product_family_slug: "amx-1g-solutions",          grand_parent_product_family: "Window Processing",                   grand_parent_product_family_slug: "amx-window-processing"},
            { product_name: "NMX-WP-N1512 Windowing Processor",   product_slug: "nmx-wp-n1512-windowing-processor", remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "1G Solutions",                                       new_product_family_slug: "amx-1g-solutions",          grand_parent_product_family: "Window Processing",                   grand_parent_product_family_slug: "amx-window-processing"},

            { product_name: "DCE-1 In-Line Controller",           product_slug: "dce-1-in-line-controller",         remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "EDID Management, Scaling, & Capture",                new_product_family_slug: "edid-management-scaling-capture", grand_parent_product_family: "Video Signal Processing", grand_parent_product_family_slug: "video-signal-processing"},
            { product_name: "SCL-1 Video Scaler",                 product_slug: "scl-1-video-scaler",               remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "EDID Management, Scaling, & Capture",                new_product_family_slug: "edid-management-scaling-capture", grand_parent_product_family: "Video Signal Processing", grand_parent_product_family_slug: "video-signal-processing"},
            { product_name: "UVC1-4K",                            product_slug: "uvc1-4k",                          remove_from_product_family: "",                                   remove_from_product_family_slug: "",                                  new_product_family: "EDID Management, Scaling, & Capture",                new_product_family_slug: "edid-management-scaling-capture", grand_parent_product_family: "Video Signal Processing", grand_parent_product_family_slug: "video-signal-processing"}
          ]
        ...
        def reassign_product_families(log, really_run)
          ...
          pfs = [
            ...
            {slug:"dvx", parent_slug: "controllers-w-switching", position: 2},
            {slug:"amx-n2400-series-4k60-4x1", parent_slug: "amx-1g-solutions", grand_parent_slug: "amx-window-processing", position: 1},
            {slug:"n2000-series-4k30-4x1", parent_slug: "amx-1g-solutions", grand_parent_slug: "amx-window-processing", position: 2},
            {slug:"amx-n1000-series-hd-4x1", parent_slug: "amx-1g-solutions", grand_parent_slug: "amx-window-processing", position: 3},
            {slug:"amx-n3000-series-hd-9x1", parent_slug: "amx-h-264-solutions-1214", grand_parent_slug: "amx-window-processing", position: 4},
            ...
            {slug:"vpx-series-presentation-switchers", parent_slug: "fixed-switchers", grand_parent_slug: "traditional-a-v-distribution", position: 4},
            {slug:"solecis-digital-switchers", parent_slug: "fixed-switchers", grand_parent_slug: "traditional-a-v-distribution", position: 5}
            ]
        ...
        def fix_hidden_nav_item_issue(log, really_run)
          # Resolves the issue where these product families were not appearing in the nav as children of Traditional A/V Distribution | Fixed Switchers
          # VPX (4K60 4x1 +1)
          # VPX (4K60 7x1 +1)
          # SDX (4K30 4x1 +1)
          # SDX (4K30 5x1 +1)
          # Somehow re-saving these product records fixes the issue. Must have something to do with product count methods.

          write_message(log, "-------------FIXING HIDDEN PRODUCT FAMILIES NAV ISSUE------------------")
          if really_run
            Product.where(cached_slug:'vpx-1401').first.save
            Product.where(cached_slug:'vpx-1701').first.save
            Product.where(cached_slug:'sdx-414-dx').first.save
            Product.where(cached_slug:'sdx-514m-dx').first.save
          end
        end  #  def fix_hidden_nav_item_issue
        ...
        def create_new_nav_site_setting(log, really_run)
          ...
          if !custom_nav_setting.present?
            if really_run
              Setting.create(name: "family-slugs-to-be-collapsed-in-nav", brand: amx, setting_type: "string", string_value: "1g-solutions, h-264-solutions, 1g-avoip-window-processing, amx-h-264-solutions, hdmi-solutions, amx-1g-solutions, amx-h-264-solutions-1214, enova-dgx, vpx-series-presentation-switchers, solecis-digital-switchers", description: "This is a custom setting only used on AMX at the moment. It hides a specified parent product family in the product nav and shows its child product families instead.")
            end
        ...
        def create_new_site_setting_to_hide_product_family_tiles(log, really_run)
          write_message(log, "-------------CREATING SITE SETTING USED TO HIDE PRODUCT FAMILY TILES------------------")
          custom_hide_family_tiles_setting = Setting.find_by_name("hide_product_family_tiles")
          if !custom_hide_family_tiles_setting.present?
            if really_run
              Setting.create(name: "hide_product_family_tiles", brand: amx, setting_type: "string", string_value: "1g-avoip-window-processing, edid-management-scaling-capture, enclosures-w-central-controllers, vpx-series-presentation-switchers, solecis-digital-switchers, amx-1g-solutions", description: "This is a custom setting only used on AMX at the moment. It hides the child product family tile buttons on a product family page.")
            end
            write_message(log, "Created site setting 'hide_product_family_tiles' ", ".green")
          else
            write_message(log, "Site setting 'hide_product_family_tiles' exists", ".green")
          end

        end  #  def create_new_site_setting_to_hide_product_family_tiles(log, really_run)

        def create_placeholder_products(log, really_run)
          placeholder_products = ["placeholder","placeholder2"]
          if really_run
            write_message(log, "-------------CREATING PLACEHOLDER PRODUCTS------------------")
            placeholder_products.each do |item|
              Product.create(name: item, brand: amx, layout_class: "vertical")
            end
          end
        end  #  def create_placeholder_products(log, really_run)
    ...
    create_placeholder_products(log, really_run)
    ...
    create_new_site_setting_to_hide_product_family_tiles(log, really_run)
    fix_hidden_nav_item_issue(log, really_run)
