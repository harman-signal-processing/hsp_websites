...
namespace :amx_nav do
  ...
  def new_product_families_to_create
    ...
    [
      ...
      { name: "N3000 Series (HD 9x1)", parent: "H.264 Solutions", parent_slug: "amx-h-264-solutions-1213", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 1},
  ...
  def reassign_product_families(log, really_run)
    ...
    pfs = [
      ...
      {slug:"amx-n3000-series-hd-9x1", parent_slug: "amx-h-264-solutions-1213", grand_parent_slug: "amx-window-processing", position: 4},
