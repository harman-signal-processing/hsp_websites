...
namespace :amx_nav do
  ...
  def new_product_families_to_create
    ...
    [
      ...
      { name: "N2400 Series (4K60 4x1)", parent: "1G Solutions", parent_slug: "amx-1g-solutions-1206", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 1},
      # nil | Video Signal Processing | Window Processing | 1G Solutions | N2000 Series (4K30 4x1)
      { name: "N2000 Series (4K30 4x1)", parent: "1G Solutions", parent_slug: "amx-1g-solutions-1206", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 2},
      # nil | Video Signal Processing | Window Processing | 1G Solutions | N1000 Series (HD 4x1)
      { name: "N1000 Series (HD 4x1)", parent: "1G Solutions", parent_slug: "amx-1g-solutions-1206", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 3},
      ...
      { name: "N3000 Series (HD 9x1)", parent: "H.264 Solutions", parent_slug: "amx-h-264-solutions-1210", grand_parent: "Window Processing", grand_parent_slug: "amx-window-processing", position: 1},
  ...
  def reassign_product_families(log, really_run)
    ...
    pfs = [
      ...
      {slug:"amx-n2400-series-4k60-4x1", parent_slug: "amx-1g-solutions-1206", grand_parent_slug: "amx-window-processing", position: 1},
      {slug:"n2000-series-4k30-4x1", parent_slug: "amx-1g-solutions-1206", grand_parent_slug: "amx-window-processing", position: 2},
      {slug:"amx-n1000-series-hd-4x1", parent_slug: "amx-1g-solutions-1206", grand_parent_slug: "amx-window-processing", position: 3},
      {slug:"amx-n3000-series-hd-9x1", parent_slug: "amx-h-264-solutions-1210", grand_parent_slug: "amx-window-processing", position: 4},
  ...
  def create_new_nav_site_setting(log, really_run)
    ...
    if !custom_nav_setting.present?
      if really_run
        Setting.create(name: "family-slugs-to-be-collapsed-in-nav", brand: amx, setting_type: "string", string_value: "1g-solutions, h-264-solutions, amx-1g-solutions, amx-h-264-solutions, hdmi-solutions, amx-1g-solutions-1206, amx-h-264-solutions-1210, enova-dgx")
      end
